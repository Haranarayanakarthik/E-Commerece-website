...
const Product = ({product}) => {
  ...
  return(
  <div>
    <div className='border border-[#e4e4e4] h-[300px] mb-4 relative overflow-hidden group transistion'>
    ...
    {/* Category */}
    <div>
      <div className='texts-sm capitalize text-gray-500 mb-1'>{category}</div>
      <Link to={`/product/${id}`}>
